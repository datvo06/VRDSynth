...
for lang in en de es fr it ja pt zh; do (python -m infoxlm_re.eval --model_type infoxlm-base --lang ${lang} > rq1_infoxlm_${lang}_chunk.log); done
for lang in en de es fr it ja pt zh; do (python -m xlmroberta_re.eval --model_type xlm-roberta-base --lang ${lang} > rq1_xlmrobera_${lang}_chunk.log); done
