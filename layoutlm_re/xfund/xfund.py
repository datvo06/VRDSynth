...
def get_relation_span(entities, rel):
    bound = []
    ...
    def _generate_examples(self, filepaths):
        for filepath in filepaths:
            ...
            for doc in data["documents"]:
                ...
                entities, relations = [], []
                id2label = {line["id"]: line["label"] for line in document}
                    ...
                    [
                        {
                            ...
                            "start_index": get_relation_span(entities, rel)[0],
                            "end_index": get_relation_span(entities, rel)[1],
                        }
