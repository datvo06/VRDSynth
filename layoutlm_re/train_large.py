...
tokenizer = AutoTokenizer.from_pretrained("microsoft/layoutxlm-large-uncased")
model = LayoutLMv2ForRelationExtraction.from_pretrained("microsoft/layoutxlm-large-uncased")
feature_extractor = LayoutLMv2FeatureExtractor(apply_ocr=False)
training_args = TrainingArguments(output_dir=f"layoutxlm-large-finetuned-xfund-{sys.argv[1]}-re",
