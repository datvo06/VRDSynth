...
approach=vrdsynth;rel_type=default;thres=1.0;hops=2;strategy=precision;python -m methods.decisiontree_ps --upper_float_thres ${thres} --hops $hops --rel_type=${rel_type} --dataset=da--cache_dir funsd_cache_word_merging_${approach}_${strategy}_${rel_type}_${thres}_${hops}_false
