...
approach=vrdsynth;rel_type=legacy;thres=1.0;hops=3;strategy=precision;python -m methods.decisiontree_ps_entity_linking --upper_float_thres ${thres} --rel_type=${rel_type} --hops $hops --cache_dir funsd_cache_entity_linking_${approach}_${strategy}_${rel_type}_${thres}_${hops}_false
